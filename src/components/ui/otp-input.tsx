            ...
            <div key={i} className={`relative h-12 w-10 ${gap ? "ml-3" : ""}`}>
                ...
                className={`h-12 w-10 rounded-[10px] border-2 text-center text-[15px] text-transparent caret-transparent outline-none transition-[background-color,border-color,box-shadow] duration-150 selection:bg-transparent focus-visible:outline-none disabled:opacity-50 ${
                  error
                    ...
                    : success
                      ...
                      : active
                        ? "border-[#E61E32] bg-white shadow-sm"
                        : char
                          ? "border-zinc-400 bg-white font-bold"
                          : "border-zinc-200 bg-zinc-50 shadow-[inset_0_1px_2px_rgba(28,25,23,0.07)]"
                }`}
              />
              ...
              >
                <AnimatePresence initial={false} mode="popLayout">
                  {char ? (
                    <motion.span
                      ...
                      transition={enter}
                      className="col-start-1 row-start-1 font-mono text-[16px] font-bold text-zinc-900"
                    >
                      {char}
                    </motion.span>
                  ) : null}
                ...
                {active && !char && !disabled ? (
                  <motion.span
                    className="col-start-1 row-start-1 block h-[17px] w-[1.5px] rounded-[1px] bg-[#E61E32]"
                    initial={{ opacity: 1 }}
                    animate={
          ...
          >
            <AnimatePresence initial={false} mode="wait">
              <motion.span
                ...
                transition={swap}
                className={`col-start-1 row-start-1 text-center ${messageTone}`}
              >
                {message}
              </motion.span>
            </AnimatePresence>
