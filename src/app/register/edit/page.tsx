...
function EditRegistrationContent() {
  ...
  if (step === "login") {
    return (
      <div className="max-w-md mx-auto bg-white border border-zinc-200 shadow-sm p-6 sm:p-8 space-y-6">
        <div className="border-b border-zinc-100 pb-4 text-center">
          <div className="w-10 h-10 bg-orange-50 text-orange-600 border border-orange-100 flex items-center justify-center rounded-none mx-auto mb-3">
            <Lock className="w-5 h-5" />
          </div>
          <h1 className="text-xl font-bold text-zinc-900 tracking-tight">Edit Registration</h1>
          <p className="text-xs text-zinc-500 mt-1">Enter your registered details to view and edit your profile</p>
        </div>
        ...
        <form onSubmit={(e) => handleLookup(e)} className="space-y-4 font-normal">
          <div>
            <label htmlFor="lookup-reg" className="block text-xs font-semibold text-zinc-700 mb-1">Registration Number *</label>
            <div className="relative">
              ...
              <input
                ...
                className="text-xs w-full pl-9 pr-3 py-2.5 border border-zinc-300 rounded-none bg-white focus:outline-none focus:border-orange-500 font-mono"
              />
            </div>
          </div>

          <div>
            <label htmlFor="lookup-ht" className="block text-xs font-semibold text-zinc-700 mb-1">Hall Ticket Number *</label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-zinc-400">
          ...
          <div className="pt-4 flex gap-4">
            ...
            >
              {isSubmitting ? <RefreshCw className="w-3.5 h-3.5 animate-spin" /> : "Verify Identity"}
            </button>
          </div>
        </form>
      </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 p-4 bg-zinc-50 border border-zinc-200">
              ...
              <div className="space-y-2 text-center sm:text-left flex-1">
                ...
                <div className="space-y-0.5">
                  <p className="text-[10px] font-bold text-red-600 flex items-center gap-1 justify-center sm:justify-start">
      ...
      <main className="flex-1 w-full max-w-5xl mx-auto p-6 flex flex-col justify-center">
        <Suspense fallback={
          <div className="py-20 flex flex-col items-center justify-center">
            ...
            <p className="text-zinc-500 text-xs">Loading registration credentials verification panel...</p>
          </div>
        }>
